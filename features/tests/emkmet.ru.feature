...
Feature: Проверка сайта emkmet.ru
  ...
  Scenario Outline: emkmet_ru секция 1 и 4
    ...
    Then email with "generated_company_name" contains "[COMPANY]: generated_company_name;Продукты : test_automation_product;[EMAIL]: automation.emk@gmail.com;[PHONE]: +7000000000" in 900 sec
  ...
  Scenario: emkmet_ru секция 2
    ...
    Then email with "generated_comment" contains "[EMAIL]: automation.emk@gmail.com;[PHONE]: +70000000000;Черный: Балка двутавровая;Нержавейка: Балка двутавровая;Пищевая нержавейка: Фланцы пищевые;Никель: Фитинги;Алюминий: Рифленые листы" in 900 sec
  ...
  Scenario: emkmet_ru секция 3
    ...
    Then email with "Услуги по металлообработке, Услуги по испытанию продукции, Услуги испытания продукции" contains "[EMAIL]: automation.emk@gmail.com;[PHONE]: +70000000000" in 900 sec
